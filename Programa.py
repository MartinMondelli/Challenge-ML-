from Clean_Dummy import clean_dummies, scale_features
import pandas as pd
...
#Choose variables
features = ["sequels", "star", "season_horror", "season_romance", "season_family", "big_comp", "english", "log_budget", "popularity_score_scaled", "length_scaled"]
...
#Mejor: {'learning_rate': 0.01, 'max_depth': 3, 'n_estimators': 400}
